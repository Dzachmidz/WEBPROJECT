...
<body>
    <nav>
        <h1>Modifikasi Data Product</h1>
        <ul>
            <li><a href="<?php echo "../products.php"; ?>">Data Product</a></li>
            <li><a href="<?php echo "#"; ?>">Tambah Data</a></li>
            <li><a href="<?php echo "../products.php"; ?>">Update Data</a></li>
            <li><a href="<?php echo "../products.php"; ?>">Hapus Data</a></li>
        </ul>
    </nav>
        <tr >
            <td colspan="3">
